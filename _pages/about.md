...
**TL;DR**: Addressing gaps in convex settings and the unique minimizer assumptions that previous works relied on, while achieving the most efficient data removal.
