...
**TL;DR**: addressing gaps in non-convex settings and unique minimizer assumption that previous works relied on, while achieving the most efficient data removal.
